---
title: "生産性アップのための一工夫"
description: "生産性アップのための一工夫。概要。最近生産性アップのためにやっていてよかったなと思うことがあったので紹介したい。要点は下記である。何度も繰り返すコマンドはスクリプトに。コミットしてしまわないように .gitignore に追加。ファイル単位で追加するのではなくディレクトリ単位で .gitignore して PATH を追加。背景。プロジェクト内での開発において、特定のコマンド列による操作を繰り返..."
pubDate: 2020-09-20
