---
title: "クライアントの Cookie などのデータを削除する Clear Site Data という仕様について"
description: "クライアントの Cookie などのデータを削除する Clear Site Data という仕様について。はじめに。Clear-Site-Data というクライアントサイドのデータを削除するための仕様がある。提案自体は2015年頃からある仕様だが、最近 Safari の Beta Release にリリースされ、もうすぐ主要ブラウザで実装が出揃う形になる。この記事では、Clear Site Da..."
pubDate: 2023-02-28
