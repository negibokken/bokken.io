...
なので、当 Web サイトは法律に強制されてプライバシーポリシーを定める必要はなさそうに思える。
...
筆者は個人情報を取り扱う際にどのようなことに気をつけるべきかを事業者になったつもりで、調査しこの Web サイトのプライバシーポリシーとして記載することにする。
...
しかしながらこれらを掲示せずに利用者の情報を取得することもできてしまうはずで、これは性善説に基づいているように感じられたかもしれない。これについては付録で述べる。
...
2 の一は身体の一部の特徴とあるので、指紋や顔などをもとに変換された ID であるでありそうだ。二に関してはユーザ ID などが該当するだろう。
...
**誰が、個人情報にあたる何をどういう目的で、どういった方法で集めるのかが明記されていることが大事**であるといえる。また、それが常識の範囲内で、記載されていない方法や、非合法の手段で取得しないことが大事である。
...
このサイトでは<a href="https://bokken.io/privacy-policy.html">プライバシーポリシーのページ</a>にあるように下記のようにプライバシーポリシーを設定した。
...
しかしながら、個人情報保護委員会もリソースが無限にあるわけではないので、すべての企業を調査することはできないし、個人情報取り扱い事業者が外部に露呈しないように個人情報やそれに等しい情報を収集し利用することも可能ではあろう。
